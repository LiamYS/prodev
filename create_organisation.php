...
<title>ProDev - Create organisation</title>
</head>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                <h6 class="mb-0 text-uppercase">Create organisation</h6>
                                <hr/>
                                <form class="row g-3" action="includes/create_org.php" method="post">
                                    <div class="col-12">
